...
<aside class="app-sidebar">
    <div class="app-sidebar__user"><img class="app-sidebar__user-avatar"
                                        ...
                                        alt="User Image">
        <div>
            <p class="app-sidebar__user-name">Yücel Toluyağ</p>
            <p class="app-sidebar__user-designation">Coding My Life</p>
        </div>
    </div>
    <ul class="app-menu">
        <li><a class="app-menu__item" href="/"><i class="app-menu__icon fa fa-dashboard"></i><span
                        class="app-menu__label">Anasayfa</span></a></li>
        <li class="treeview"><a class="app-menu__item" href="/admin/customers/customers" data-toggle="treeview"><i
                        class="app-menu__icon fa fa-users"></i><span class="app-menu__label">Müşteriler</span><i
                        class="treeview-indicator fa fa-angle-right"></i></a>
            <ul class="treeview-menu">
                <li><a class="treeview-item" href="/admin/customers/customers"><i class="icon fa fa-circle-o"></i>
...
</aside><?php /**PATH C:\xampp\htdocs\altaikai\resources\views/admin/layout/partials/sidebar.blade.php ENDPATH**/ ?>